...
<cms:template title='en / History' >
	<cms:editable name='history_title' label='Title' type='text' />
	<cms:editable name='history_content' label='Content' type='richtext' />
</cms:template>
...
<div class="bgHolder">
	...
	<div class="container mar_t_20 pad_b_m_5">
		<div class="row">
		<cms:pages masterpage='en/ajax/history.php' >
