...
<cms:template title='en / News' >
	<cms:editable name='news_title' label='Title' type='text' />
	<cms:editable name='news_content' label='Content' type='richtext' />
</cms:template>
