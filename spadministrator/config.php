<?php
    ...
    define( 'K_DB_NAME', 'workspace_demo' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'workspace_demo' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'workspace_demo' );
    // 7.
